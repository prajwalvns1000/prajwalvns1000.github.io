    ...
    public function seed_initial_content() {
        ...
        $experiences = [
            ...
            [
                ...
                'title'   => 'Instrumentation Engineering Intern',
                'start'   => '2026',
                'end'     => '2026',
                'location'=> 'Mysuru, Karnataka',
                'tech'    => 'Industrial Automation, Sensor Calibration, Process Control Systems',
                'content' => 'Hands-on practical training in industrial sensor calibration, telemetry nodes, and plant instrumentation maintenance.'
            ]
        ];
